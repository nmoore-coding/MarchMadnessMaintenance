...
public class MarchMadnessGUI extends Application {
    ...
    private void simulate(){
       ...
       // ment to go throught all of bracket and get the guess of bracket.
       for (int i = 62; i >= 0; i--) {
            if(teamInfo.getGuessC(simResultBracket,i)){
            }   
       }
...
//           bracketPane.setDisable(true);
           ...
           //Changed These things for testing -Svet
           bracketPane.setFinalized(true);
           selectedBracket.setFinalized(true);
