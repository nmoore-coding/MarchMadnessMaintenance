...
public class Bracket implements Serializable //Hillary: This bracket class is to implement the serializable interface inorder to be serialized
{
    ...
    //added a guess boolean here ass well becuase i was trying things not sure what I wanted to try here -Svet
    ...
    //Getters and setters of Guess for bracket
    ...
    // Made a way to finalinze bracket, I don't remember what happened here -Svet
